...
func (e *EncryptManager) Encrypt(r io.Reader, encryptionMethod string) (map[string][]byte, error) {
	...
	case "aes256-gcm":
		...
		decryptData, err := e.encryptCipherAndNonce(cipherKey, nonce)
		if err != nil {
			return nil, err
		}
		out = map[string][]byte{
...
// with AES256-CFB using the passphrase provided during instantiation of EncryptManager
...
// DecryptParams is used to configure decryption for AES256-GCM
// It expects a hex encoded CipherKey and Nonce
...
func (e *EncryptManager) Decrypt(r io.Reader, params *DecryptParams) ([]byte, error) {
	if params == nil {
		return e.decryptCFB(r)
	}
	return e.decryptGCM(r, params.CipherKey, params.Nonce)
}
